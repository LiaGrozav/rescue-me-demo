...
const About = () => {
  ...
  <div className="parent">
    <div className="container-about">
      ...
      {/* <div className="about"><h1 className="ab">About</h1> */}
    
         <img src={aboutUs} alt="" />
         </div>
      <div className="about-text">  <p>
             Welcome to our pet adoption website. 
             <br />
 ...
 <br/>
             ...
             <br/>
          Thank you for considering adoption and for visiting our website. 
          <br/>We
          hope that you find your perfect pet and become a part of our
             adoption community! 🐶😺</p>
            {/* <a href="https://www.freepik.com/free-vector/flat-design-people-with-pets-set_14669667.htm#from_view=detail_collection">Image by pikisuperstar</a> on Freepik */}
                      </div>
...
//           </p> */}
//           <p>
//             We believe that every pet deserves a loving home whether you're looking for a
