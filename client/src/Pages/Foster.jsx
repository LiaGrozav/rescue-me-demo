...
const Foster = () => {
  return (
    <div className="foster-container">
      ...
      <Row>
        <Col className="foster-text" md={7}>
          <h2>Welcome to our Foster page!</h2>
          <p>
        ...
        <Col className=" form_container foster-form">
          <h2>Please fill in this form</h2>
          <Form className="form">
            <Form.Group controlId="formGridFirstN" className="text-start">
              <Form.Label>First Name</Form.Label>
              <Form.Control placeholder="First Name" className="form-control" />
            </Form.Group>

            <Form.Group controlId="formGridLastN" className="text-start">
              <Form.Label>Last Name</Form.Label>
              <Form.Control placeholder="Last Name" className="form-control" />
            </Form.Group>
